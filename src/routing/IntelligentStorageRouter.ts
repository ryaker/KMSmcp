...
import { UnifiedKnowledge, StorageDecision, RoutingRule, CacheLevel } from '../types/index.js'
...
export class IntelligentStorageRouter {
  ...
  private getSecondaryStorage(
    ...
    knowledge: Partial<UnifiedKnowledge>
  ): ('mem0' | 'neo4j' | 'mongodb')[] {
    const secondary: ('mem0' | 'neo4j' | 'mongodb')[] = []
