...
function shouldRecordHeaders(type, recordHeaders) {
    return !!recordHeaders && ((0, type_utils_1.isBoolean)(recordHeaders) || recordHeaders[type]);
}
function shouldRecordBody(_a) {
    ...
    if (isBlobURL(url))
        return false;
    if ((0, type_utils_1.isBoolean)(recordBody))
        return true;
    if ((0, type_utils_1.isArray)(recordBody))
        return matchesContentType(recordBody);
    var recordBodyType = recordBody[type];
    if ((0, type_utils_1.isBoolean)(recordBodyType))
                ...
                case 0:
                    ...
                    performanceEntry = findLast(urlPerformanceEntries, function (entry) {
                        return isResourceTiming(entry) &&
                            ...
                            ((0, type_utils_1.isUndefined)(start) || entry.startTime >= start) &&
                            ((0, type_utils_1.isUndefined)(end) || entry.startTime <= end);
                    });
...
function _tryReadXHRBody(_a) {
    ...
    if ((0, type_utils_1.isNullish)(body)) {
        return null;
    }
    ...
    if ((0, type_utils_1.isString)(body)) {
        return body;
    }
    if ((0, type_utils_1.isDocument)(body)) {
        return body.textContent;
    }
    if ((0, type_utils_1.isFormData)(body)) {
        return (0, request_utils_1.formDataToQuery)(body);
    }
    if ((0, type_utils_1.isObject)(body)) {
        try {
...
var exposesServerTiming = function (event) {
    return !(0, type_utils_1.isNull)(event) && (event.entryType === 'navigation' || event.entryType === 'resource');
};
...
function _tryReadResponseBody(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        ...
        return __generator(this, function (_c) {
            ...
            if (!(0, type_utils_1.isNull)(cannotReadBodyReason)) {
