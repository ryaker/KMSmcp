...
var isValidStringArray = function (value) {
    return (0, type_utils_1.isArray)(value) && value.every(function (item) { return (0, type_utils_1.isString)(item); });
};
var initializeSelectedChoices = function (initialValue, questionType) {
    if ((0, type_utils_1.isString)(initialValue)) {
        return initialValue;
    }
...
var initializeOpenEndedState = function (initialValue, choices) {
    if ((0, type_utils_1.isString)(initialValue) && !choices.includes(initialValue)) {
        return {
            isSelected: true,
...
function RatingQuestion(_a) {
    ...
    var _b = __read((0, hooks_1.useState)(function () {
        if ((0, type_utils_1.isNumber)(initialValue)) {
            return initialValue;
        }
        if ((0, type_utils_1.isArray)(initialValue) && initialValue.length > 0 && (0, type_utils_1.isNumber)(parseInt(initialValue[0]))) {
            return parseInt(initialValue[0]);
        }
        if ((0, type_utils_1.isString)(initialValue) && (0, type_utils_1.isNumber)(parseInt(initialValue))) {
    ...
    return (<preact_1.Fragment>
            ...
            <BottomSection_1.BottomSection text={question.buttonText || (appearance === null || appearance === void 0 ? void 0 : appearance.submitButtonText) || 'Submit'} submitDisabled={(0, type_utils_1.isNull)(rating) && !question.optional} appearance={appearance} onSubmit={function () { return onSubmit(rating); }} onPreviewSubmit={function () { return onPreviewSubmit(rating); }} skipSubmitButton={question.skipSubmitButton}/>
        </preact_1.Fragment>);
}
...
function MultipleChoiceQuestion(_a) {
    ...
    var handleChoiceChange = function (val, isOpenChoice) {
        ...
        if (isMultipleChoiceQuestion && (0, type_utils_1.isArray)(selectedChoices)) {
    ...
    var isSubmitDisabled = function () {
        ...
        if ((0, type_utils_1.isNull)(selectedChoices)) {
            return true;
        }
        if ((0, type_utils_1.isArray)(selectedChoices)) {
    ...
    return (<preact_1.Fragment>
            ...
            var isChecked = isOpenChoice
                ...
                : isSingleChoiceQuestion
                    ...
                    : (0, type_utils_1.isArray)(selectedChoices) && selectedChoices.includes(choice);
