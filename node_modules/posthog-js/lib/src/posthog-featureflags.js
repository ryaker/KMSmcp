...
function fnv1a(str) {
    ...
    var hexString = (hash >>> 0).toString(16);
...
// We will remove these once we get an idea of how scale looks without them.
var HASHED_EXEMPT_TOKENS = [
    '7c6f7b45',
    '66c1f69c',
    '2727f65a',
    'f3287528',
...
var hashedExemptTokens = new Set(HASHED_EXEMPT_TOKENS);
function shouldUseDecide(token) {
    var tokenHash = fnv1a(token);
    return hashedExemptTokens === null || hashedExemptTokens === void 0 ? void 0 : hashedExemptTokens.has(tokenHash);
}
var PostHogFeatureFlags = /** @class */ (function () {
    ...
    PostHogFeatureFlags.prototype._callFlagsEndpoint = function (options) {
        ...
        var useRemoteConfigWithFlags = this._instance.config.__preview_flags_v2 && this._instance.config.__preview_remote_config;
        var flagsRoute = shouldUseDecide(this._instance.config.token)
            ? '/decide?v=4'
